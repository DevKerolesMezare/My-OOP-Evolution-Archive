...
private:
    ...
    static short _ReadMainMenueOption()
    {
        ...
        short Choice = clsInputValidate::ReadShortNumberBetween(1, 11, "Enter Number between 1 to 10? ");
        return Choice;
    }
    ...
    static void _ShoweCurrencyExchange()
    {
...
public: 
    ...
    static void ShowMainMenue()
    {
        ...
        cout << setw(38) << left << "" << "\t[4] Update Client Info.\n";

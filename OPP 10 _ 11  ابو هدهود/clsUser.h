...
private:
    ...
    string _PrepareLogInRecord(string Sperator = "#//#")
    {
        ...
        LoginRecord += clsUtil::EncryptText(Password)+Sperator;
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Sperator = "#//#")
    {
        ...
        vector <string> vLoginRegisterRecord = clsString::Split(Line , Sperator);
...
public:
    ...
    enum enPermissions {
        ...
        pUpdateClients = 8, pFindClient = 16, pTranactions = 32, pManageUsers = 64, pShowLogInScreen = 128, pShowATMScreen = 256
    };

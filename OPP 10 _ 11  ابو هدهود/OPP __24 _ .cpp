...
{
private:
    string _MainProgrammingLanguag;
...
public:
    ...
    {
        _MainProgrammingLanguag = MainProgrammingLanguage;
    }

    void setMainProgrammingLanguag(string MainProgrammingLanguag)
    {
        _MainProgrammingLanguag = MainProgrammingLanguag;
    }

    string MainProgrammingLanguag()
    {
        return _MainProgrammingLanguag;
    }
    ...
    void Print()
    {
        ...
        cout << "\nSalary    : " << Salary();
        cout << "\nProgrammingLanguag: " << MainProgrammingLanguag();
        cout << "\n___________________\n";
    }
...
int main()
{
    clsDeveloper Developer1(10, "Kero", "Alngar", "A@a.com", "8298982", "Egy", "Web Developer", 5000 , "C++");
    Developer1.Print();
